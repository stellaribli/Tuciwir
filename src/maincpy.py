...
layarRev1 = MainReviewer1()
layarRev2 = MainReviewer1()
layarPembayaran = Pembayaran()
halUploadCV = UploadCV()
...
widget.addWidget(halUploadCV) #Index jadi 5
widget.addWidget(PilihPaket()) #Index jadi 6
widget.addWidget(layarPembayaran) #Index jadi 7
widget.addWidget(layarRev1) #Index jadi 8
widget.addWidget(layarRev2) #Index jadi 9
widget.setCurrentIndex(0) 
